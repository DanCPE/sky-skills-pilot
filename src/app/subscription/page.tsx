...
function PaidPackageCard({
  ...
  if (badgeLabel) {
    return (
      <article className="relative flex min-h-[430px] flex-col overflow-visible rounded-xl border-2 border-[#FFD700] bg-[radial-gradient(184.71%_103.88%_at_50%_0%,rgba(255,215,0,0.15)_0%,rgba(255,215,0,0)_100%),linear-gradient(135deg,#413256_0%,#2D1B4E_50%,#181121_100%)] p-6 text-white shadow-[0_20px_50px_rgba(80,18,165,0.32)]">
        ...
        {isCaptain && (
          <div className="absolute -right-12 bottom-6 z-28 w-40 -rotate-45">
            ...
            <span className="relative block bg-red-600 px-2 py-2 text-center text-[9px] font-black uppercase leading-3 tracking-[0.08em] text-white shadow-xl ring-1 ring-red-300/50">Soft opening price</span>
  ...
  return (
    <article className="flex min-h-[430px] flex-col rounded-xl border border-[#E5E7EB] bg-white p-6 shadow-[0_10px_20px_-12px_rgba(17,24,39,0.28)] dark:border-white/10 dark:bg-zinc-950">
...
export default async function SubscriptionPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F7F6F8] text-zinc-950 dark:bg-zinc-900 dark:text-zinc-100">
      <section className="relative h-[280px] overflow-hidden bg-[#5012A5] text-white">
        <Image
        ...
        <div className="absolute inset-x-0 bottom-0 h-16 bg-[#F7F6F8] dark:bg-zinc-900" />
        <div className="relative z-10 mx-auto flex h-[216px] max-w-5xl flex-col items-center px-6 pt-7 text-center">
      ...
      <section className="relative z-10 -mt-12 bg-[#F7F6F8] px-5 pb-20 dark:bg-zinc-900">
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-2 xl:grid-cols-4">
          ...
          {packages.map((pkg, index) => (
            <PaidPackageCard
              ...
              pkg={pkg}
              index={index}
              badgeLabel={pkg.key === "captain" ? "Recommended" : null}
            />
          ))}
        </div>
