...
export default function ModeSelection({ onStart }: ModeSelectionProps) {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      onStart((await response.json()) as JoyStickGameQuizResponse);
    } catch (err) {
    ...
    <div className="mx-auto max-w-3xl">
      <div className="mb-8 text-center">
        ...
        <p className="text-zinc-600 dark:text-zinc-400">
          Fly the hexagon with a joystick or WASD while answering mental math.
        </p>
      </div>
      ...
      <div className="mb-8 grid gap-6 md:grid-cols-2">
        ...
        >
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Set difficulty, question rhythm, obstacle speed, obstacle count, and
