    ...
    <div className="mx-auto max-w-2xl">
      <div className="rounded-2xl border-2 border-amber-200 bg-amber-50 p-8 text-center dark:border-amber-900 dark:bg-amber-950">
        ...
        <h2 className="mb-4 text-2xl font-bold text-amber-900 dark:text-amber-100">
          Wait! You have {skippedCount} {skippedCount === 1 ? "question" : "questions"} remaining
        </h2>
        ...
        <div className="mb-8 rounded-xl border border-amber-200 bg-amber-100 p-4 dark:border-amber-800 dark:bg-amber-900">
          <div className="flex items-center justify-center gap-8 text-sm">
            ...
            <div>
              <span className="font-semibold text-amber-900 dark:text-amber-100">{skippedCount}</span>
              <span className="ml-1 text-amber-700 dark:text-amber-300">skipped</span>
            </div>
          </div>
        </div>
        ...
        <p className="mb-8 text-amber-800 dark:text-amber-200">
          Would you like to go back and answer the {skippedCount === 1 ? "skipped question" : "skipped questions"},
          or finish the quiz now? Skipped questions will be marked as incorrect.
        </p>
