      ...
      <div className="flex flex-row justify-center gap-1.5 sm:gap-2">
        {[0, 1, 2, 3, 4, 5].map((option) => (
          <button
            ...
            disabled={disabled}
            className={`flex-1 max-w-[100px] rounded-xl border-2 font-bold transition-all ${
          ...
          >
            <span className={selectedAnswer === String(option) ? "text-white" : "text-zinc-900 dark:text-zinc-100"}>{option}</span>
          </button>
        ))}
      </div>
